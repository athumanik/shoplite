...
<head>
    ...
    <title>POS - Shoplite Agrovet</title>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        ...
                        <div class="product-card bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden cursor-pointer">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    <span class="text-lg font-bold text-green-600">$24.99</span>
                        ...
                        <div class="product-card bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden cursor-pointer">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Animal Health</p>
                                <div class="flex items-center justify-between mt-3">
                                    <span class="text-lg font-bold text-green-600">$15.99</span>
                        ...
                        <div class="product-card bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden cursor-pointer">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Crop Protection</p>
                                <div class="flex items-center justify-between mt-3">
                                    <span class="text-lg font-bold text-green-600">$22.50</span>
                        ...
                        <div class="cart-item p-3 bg-gray-50 rounded-lg">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">$24.99 × 2</p>
                                </div>
                                <div class="text-right">
                                    <div class="font-bold text-gray-900">$49.98</div>
                        ...
                        <div class="cart-item p-3 bg-gray-50 rounded-lg">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">$19.99 × 1</p>
                                </div>
                                <div class="text-right">
                                    <div class="font-bold text-gray-900">$19.99</div>
                                    <div class="flex items-center space-x-2 mt-1">
                                        <button class="w-6 h-6 rounded-full bg-gray-200 flex items-center justify-center">
                                            <i class="fas fa-minus text-xs"></i>
                                        </button>
