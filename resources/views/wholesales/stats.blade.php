        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="flex items-center mt-2">
                    ...
                    <span class="text-gray-500 text-sm ml-2 hidden sm:inline" id="lastMonth">vs --</span>
                </div>
            </div>
    ...
    <div class="stat-card bg-white rounded-xl border border-gray-200 p-4 sm:p-6 fade-in">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-2" id="topOrder">--</p>
                <div class="flex items-center mt-2">
                    <span class="text-green-600 text-sm font-medium flex items-center">
                        {{-- increase or decrease --}}
                        <i class="fas fa-arrow-up mr-1"></i>
    ...
    <div class="stat-card bg-white rounded-xl border border-gray-200 p-4 sm:p-6 fade-in">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-2" id="salesValue">..</p>
                <div class="flex items-center mt-2">
                    <span class="text-green-600 text-sm font-medium flex items-center">
                        {{-- increase or decrease --}}
                        <i class="fas fa-arrow-up mr-1"></i>
                    ...
                    <span class="text-gray-500 text-sm ml-2 hidden sm:inline" id="state">..</span>
                </div>
            </div>
    ...
    <div class="stat-card bg-white rounded-xl border border-gray-200 p-4 sm:p-6 fade-in">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-2" id="topProduct">Feed</p>
                <div class="flex items-center mt-2">
                    <span class="text-gray-500 text-sm" id="revenue">..</span>
                </div>
            </div>
