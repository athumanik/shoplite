        ...
        return $form
            ->schema([
                ...
                Group::make()
                 ...
                 Group::make()
                    ->schema([
                        Section::make('Sales Assured')
                            ->schema([
                                TextInput::make('notes')
                                    ->default('Sales made by ' . Auth::user()->name . ' @ ' . now())
                                    ->readOnly(),
            ...
            ->columns([
                ...
                TextColumn::make(' ')
                    ...
                    ->getStateUsing(function ($record) {
                        return sales_item::where('sales_id', $record->id)->sum('quantity');
                    }),
                        ...
                        DeleteAction::make()
                            ->successNotification(
                                Notification::make()
                                    ->success()
                                    ->title('Sales Deleted')
                                    ->body('The Sales Product deleted successfully')
